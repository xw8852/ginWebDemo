ssh 链接后  保持脚本还在运行  使用  tmux
tmux attach  查看正在运行的脚本
intelj　激活ｌｉｃｅｎｓｅ
http://idea.liyang.io
...
gin:
https://github.com/gin-gonic/gin/tree/develop
...
创建表　： CREATE DATABASE IF NOT EXISTS miwei default charset utf8 COLLATE utf8_general_ci;
创建用户：　CREATE USER 'miniapp'@'%' IDENTIFIED BY 'mini8875901';
授权：GRANT ALL ON miwei.* TO 'miniapp'@'%';
